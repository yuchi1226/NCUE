...
int num[10]={0Xee,0X07,0X46,0X6a,0X52,0X12,0Xe2,0X02,0X42,0X82};

int location1[4]={0X7f10,0Xdf10,0Xbf10,0Xef10};
int location2[4]={0X7f20,0Xdf10,0Xbf20,0Xef10};

int arr[4]={0Xb000,0Xd000,0Xe000,0Xd000};
		  ...
		  if(x<10)
			{
				for(m=0;m<x;m++)
					for(n=0;n<4;n++)
					{						
						tGPIO_E->DOUT = num[x-1];
						tGPIO_C->DOUT = location1[n];
						tGPIO_A->DOUT = arr[n];
			...
			{			
				...
				for(m=0;m<x;m++)
					...
					{					
						if(n%2==0)
						{
							tGPIO_E->DOUT = num[j-1];
							tGPIO_C->DOUT = location2[n];
						}
						if(n%2!=0)
						{
							tGPIO_E->DOUT = num[(x-1)%10];
							tGPIO_C->DOUT = location2[n];
